...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (empty($state) || empty($city) || empty($zip) || empty($address)) {
        ...
        if (empty($errors)) {
            ...
            $sql = "INSERT INTO `application_request`(`email_id`,`permission`, `full_name`, `Mno`,`incident_date`,`address`,`state`,`city`,`zip`,`police_station`,`police_station_user`,`complaint_date`,`ip_address`,`description_complaint`) values('$email_id', '2', '$full_name','$Mno','$incident_date','$address','$state','$city','$zip','$police_station','$police_station_user','$complaint_date','$ip_address','$description_complaint')";
...
-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );">
				...
				<div class="col-lg-8">
					...
					-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );" >
						...
						<div class="card-body">
							<form action="register_for_us.php" method="POST">
							<div class="row mb-3">
								<div class="col-sm-3">
									<h6 class="mb-0">Email Id</h6>
								</div>
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" value="<?php  echo $email_id; ?>"   name="email_id" id="email_id" readonly>
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control" name="full_name" id="full_name"  value="<?php  echo $full_name; ?>" readonly  >
								</div>
							</div>
                            ...
                            <div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control" name="Mno" id="Mno"  value="<?php  echo $Mno; ?>" readonly  >
								</div>
							</div>
...
?>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('incident_date').max = currentDate.toISOString().split('T')[0];
                            ...
                            <div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
								<input type="text" class="form-control"  value="<?php  echo $address; ?>"  name="address"id="address" readonly >
								</div>
							</div>
							...
							<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" placeholder="enter the state" name="state" id="state"  value="<?php  echo $state; ?>" readonly > 
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
							...
							<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" placeholder="enter the city" name="city" id="city"  value="<?php  echo $city; ?>" readonly >
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
							...
							<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" placeholder="enter the zip" name="zip" id="zip"  value="<?php  echo $zip; ?>" readonly >
								</div>
							</div>
    ...
    WHERE police_station_list.police_email_id = profile.police_station";
                        ...
                        <p class="text-muted font-size-sm">&nbsp;&nbsp;please complaint your profile first if not</p>
