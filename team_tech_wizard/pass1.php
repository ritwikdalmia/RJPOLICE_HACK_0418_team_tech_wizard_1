...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql_email = "SELECT * FROM `users` WHERE email_id = '$email_id'";
    ...
    $sql = "UPDATE users SET password_token='$password_token',password_code=0 WHERE email_id='$email_id'";
									...
									<table border='0' align='center' width='160' cellpadding='0' cellspacing='0' bgcolor='5caad2' style=''>
										...
										<tr>
											<td align='center' style='color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;'>
                                                ...
                                                <a href='http://www.smilewellnessfoundation.org/team_tech_wizard/password_activate.php?password_token=".$password_token."' style='color: #ffffff; text-decoration: none;'>reset password </a>
												</div>
											</td>
										</tr>
