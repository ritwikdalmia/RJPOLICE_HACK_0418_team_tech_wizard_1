...
<?php include 'nav.php';?>
		...
		<div class="main-body">
			...
			<div class="row">
					...
					<!--card form-->
							...
							<p style="color:red;"><b>FEEDBACKS</b></p>
					</div>
    ...
    $select_display2="select * from application_request where shareability='yes' order by complaint_id DESC" ;
...
echo "
                                ...
                                <div><br><br></div>
                                <a class='btn btn-primary' href='report_feedback.php?complaint_id=$complaint_id' >report</a>
