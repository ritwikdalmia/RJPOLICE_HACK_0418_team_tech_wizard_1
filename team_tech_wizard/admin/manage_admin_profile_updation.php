			...
			<div class="row">
                <div class="col-lg-9 pl-5">
					...
					-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );" >
						...
						<div class="card-body">
							<form action="manage_admin_profile_updation.php" method="POST">
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $select_display="select admin_profile.gender,admin_profile.police_station,admin_profile.address, admin_profile.state,admin_profile.city,admin_profile.zip,admin_change_address.address_id,admin_change_address.address,admin_change_address.state,admin_change_address.city,admin_change_address.zip,admin_change_address.file_upload,admin_change_address.comment,admin_change_address.permission from admin_profile INNER JOIN admin_change_address ON admin_change_address.email_id=admin_profile.email_id where admin_change_address.email_id='$email_id' " ;
...
<div class='card-body'>
    <div class='d-flex flex-column align-items-center text-center'>
        ...
        <a class='btn btn-primary' href='admin_view_uploaded_files.php?address_id=$address_id' target='_blank'>View file</a>";
                     
if($permission=='2'){
    echo" <a class='btn btn-secondary' href='admin_pending_address_update.php?address_id=$address_id'>Pending</a>
 ";}
...
";
    ...
    $select_display="select admin_profile.gender,admin_profile.police_station,admin_profile.address, admin_profile.state,admin_profile.city,admin_profile.zip,admin_change_address.address_id,admin_change_address.address,admin_change_address.state,admin_change_address.city,admin_change_address.zip,admin_change_address.file_upload,admin_change_address.comment,admin_change_address.permission from admin_profile INNER JOIN admin_change_address ON admin_change_address.email_id=admin_profile.email_id where admin_change_address.permission='2'" ;
    $sql1 = mysqli_query($conn,$select_display);
    while($row=mysqli_fetch_array($sql1)){
 ...
 ";}
  ...
  ";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $select_display="select admin_profile.gender,admin_profile.police_station,admin_profile.address, admin_profile.state,admin_profile.city,admin_profile.zip,admin_change_address.address_id,admin_change_address.address,admin_change_address.state,admin_change_address.city,admin_change_address.zip,admin_change_address.file_upload,admin_change_address.comment,admin_change_address.permission from admin_profile INNER JOIN admin_change_address ON admin_profile.email_id=admin_change_address.email_id inner join admin on admin.police_station=admin_change_address.police_station where admin.email_id='$email_id1' and chnage_address.email_id='$email_id_user' order by chnage_address.address_id " ;
        $sql1 = mysqli_query($conn,$select_display);
    while($row=mysqli_fetch_array($sql1)){
...
<a class='btn btn-primary' href='admin_view_uploaded_files.php?address_id=$address_id' target='_blank'>View file</a>
<a class='btn btn-warning' href='admin_pending_address_update.php?address_id=$address_id'>pending</a>
...
";
        ...
        $select_display="select admin_profile.gender,admin_profile.police_station,admin_profile.address, admin_profile.state,admin_profile.city,admin_profile.zip,admin_change_address.address_id,admin_change_address.address,admin_change_address.state,admin_change_address.city,admin_change_address.zip,admin_change_address.file_upload,admin_change_address.comment,admin_change_address.permission from admin_profile INNER JOIN admin_change_address ON admin_profile.email_id=admin_change_address.email_id inner join admin on admin.police_station=admin_change_address.police_station where admin.email_id='$email_id1' order by chnage_address.address_id " ;
        $sql1 = mysqli_query($conn,$select_display);
    while($row=mysqli_fetch_array($sql1)){
