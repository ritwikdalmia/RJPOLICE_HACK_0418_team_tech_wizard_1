...
$showError=false;
 ...
 $select_display= "select full_name,email_id,Mno,age,aadhar_card,gender,police_station,address,state,city,zip from profile where email_id='$email_id'" ;
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
   ...
   //$email=$_POST['email'];
   $select= "select * from profile where email_id='$email_id'";
   $sql = mysqli_query($conn,$select);
   $row = mysqli_fetch_assoc($sql);
   
   
	$update = "update profile set gender='$gender',address='$address',state='$state',city='$city',zip='$zip' where email_id='$email_id' and gender='NULL'";
...
-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );">
						<div class="card-body">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" value="<?php echo $age?>" name="age" id="age" disabled>
								</div>
							</div>
							<?php 
							$sql_option3 = "
							SELECT gender from profile where email_id='$email_id'";
...
<div class='col-sm-9 text-secondary'>
	<input type='text' class='form-control' value=' $gender' pattern='male|female' title='Please enter either 'male' or 'female'' disabled>
</div>
</div>";}
else{
echo "
	<div class='row mb-3'>
								...
								<div class='col-sm-9 text-secondary'>";
								?>
									<input type='text' class='form-control' placeholder='enter gender' name='gender' id='gender' value="<?php echo $gender?>" pattern='male|female' title='Please enter either male or female' required>
								</div>
							</div>
							<?php
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" value="<?php echo $aadhar_card?>"  name="aadhar_card" id="aadhar_card" disabled>
								</div>
							</div>
    ...
    WHERE police_station_list.police_email_id = profile.police_station";
							...
							<?php 
							$sql_option3 = "
							SELECT address from profile where email_id='$email_id'";
...
echo "
	<div class='row mb-3'>
							...
							<?php 
							$sql_option3 = "
							SELECT state from profile where email_id='$email_id'";
...
echo "
	<div class='row mb-3'>
							...
							<?php 
							$sql_option3 = "
							SELECT city from profile where email_id='$email_id'";
...
echo "
	<div class='row mb-3'>
							...
							<?php 
							$sql_option3 = "
							SELECT zip from profile where email_id='$email_id'";
