			...
			<div class="row">
                <div class="col-lg-9 pl-5">
					...
					-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );" >
						...
						<div class="card-body">
							<form action="manage_police_station_list.php" method="POST">
							...
							<div class="row mb-3">
								...
								<input type="text" class="form-control"  name="police_station_name" id="police_station_name" required>
								</div>
							</div>					
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $select_display="select * from police_station_list where police_station_name='$police_station_name' " ;
...
<div class='card-body'>
    <div class='d-flex flex-column align-items-center text-center'>
        ...
        <div><br><br></div>";
        echo" <a class='btn btn-primary' href='view_police_station_list.php?police_station_id=$police_station_id '>View</a>
...
";
    ...
    $select_display="select * from police_station_list order by police_station_id" ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $select_display="select * from police_station_list INNER JOIN admin on admin.police_station=police_station_list.police_email_id where police_station_name='$police_station_name' and admin.email_id='$email_id1'" ;
                   $sql1 = mysqli_query($conn,$select_display);
                   while($row=mysqli_fetch_assoc($sql1)){
