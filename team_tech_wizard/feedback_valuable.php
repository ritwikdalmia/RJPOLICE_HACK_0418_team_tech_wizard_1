...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin']!=true){
	...
	$select_display1="SELECT complaint_id,police_station_user,police_station,complaint_assigned_to FROM application_request where complaint_id='$complaint_id1'";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$feedback_permission=$_POST['feedback_permission'];
	$user_rating=$_POST['user_rating'];
	

 
	$update1 = "UPDATE application_request SET feedback='$feedback',shareability='$shareability',feedback_permission='$feedback_permission',user_rating='$user_rating' where complaint_id='$complaint_id'";
...
-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );">
						<div class="card-body">
							...
							<div class="row mb-3">
								<div class="col-sm-3">
									<h6 class="mb-0">Star Rating</h6>
								</div>
							 	<div class="col-sm-9 text-secondary">
                                 <select name="user_rating" class="form-control" id="user_rating" required>
							...
							<div class="col-sm-9 text-secondary">
									<textarea class="form-control" rows='3' placeholder="enter your feedback" name="feedback" id="feedback" required></textarea>
								</div>
							</div>
                            ...
                            <div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="hidden" class="form-control" name="feedback_permission" id="feedback_permission" value="1" >
								</div>
							</div>
