...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "UPDATE admin SET login_attempts=0,password_token='$password_token',password_code=0 WHERE email_id='$email_id'";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-4">
     <h1 class="text-center">account locked Password-reset</h1><br><br>
     <form action="account_locked.php" method="post">
