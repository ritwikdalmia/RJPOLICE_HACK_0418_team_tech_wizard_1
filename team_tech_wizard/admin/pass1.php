...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql_email = "SELECT * FROM `admin` WHERE email_id = '$email_id'";
    ...
    $sql = "UPDATE admin SET password_token='$password_token',password_code=0 WHERE email_id='$email_id'";
														...
														<tr>
															<td align='center' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
																...
																<div style='line-height: 24px'>
																   ...
																   please reset your password  and login  Ip address is ".$ip_address."  at time ".$timestamp." <br>
									...
									<table border='0' align='center' width='160' cellpadding='0' cellspacing='0' bgcolor='5caad2' style=''>
										...
										<tr>
											<td align='center' style='color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;'>
                                                ...
                                                <a href='http://www.smilewellnessfoundation.org/team_tech_wizard/admin/password_activate.php?password_token=".$password_token."' style='color: #ffffff; text-decoration: none;'>admin  password </a>
												</div>
											</td>
										</tr>
...
<html lang="en">
  ...
  <h1 class="mb-0" style="text-align: center;">PASSWORD RESET</h1><BR>
						...
						<div class="card-body">
							...
							<img src="images/logo1.png" alt="Admin" class="rounded-circle bg-transparent"  height="200" width="200">
								<div class="mt-3">
									...
									<p class="text-muted font-size-sm">Password Reset</p>
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-sm-3"></div>
									<div class="col-sm-9 text-secondary">
										<input type="submit" class="btn btn-primary px-4" value="continue">
									</div>
								</div>
							</div>
