...
<?php include 'nav.php';?>
    ...
    $select_display2="select * from application_request where email_id='$email_id' and permission=2" ;
...
$select_display2="select * from application_request where email_id='$email_id' and permission=1" ;
    $sql3 = mysqli_query($conn,$select_display2);
    while($row=mysqli_fetch_assoc($sql3)){
...
$select_display2="select * from application_request where email_id='$email_id' and permission=0" ;
    $sql3 = mysqli_query($conn,$select_display2);
    while($row=mysqli_fetch_assoc($sql3)){
