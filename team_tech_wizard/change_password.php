...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    include 'dbconnect.php';
    $aadhar_card1=$_POST["aadhar_card"];
    $aadhar_card= chunk_split($aadhar_card1, 4, ' ');
    $current_transaction_password=$_POST["password"];
    

    $sql = "Select * from users where aadhar_card='$aadhar_card'  and email_id='$email_id'";
    ...
    if ($num == 1){
        while($row=mysqli_fetch_assoc($result)){
            ...
            if (password_verify($current_transaction_password,$store)){ 
                ...
                $sql_update="update users set password='$transaction_pass' where aadhar_card='$aadhar_card' and email_id='$email_id'";
						...
						<div class="card-body">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" placeholder="enter aadhaar number" name="aadhar_card" id="aadhar_card" pattern="[0-9]{12}" title="Please enter a valid 12-digit aadhar card number." required>
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-3">
