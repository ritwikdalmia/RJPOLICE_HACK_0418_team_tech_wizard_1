...
$select_admin_profile= "select email_id,address,state,city,zip,police_station,gender from admin_profile where email_id='$email_id'" ;
 $sql_admin_profile = mysqli_query($conn,$select_admin_profile);
 while($row2 = mysqli_fetch_array($sql_admin_profile)){
...
$select_display= "select * from admin_change_address where email_id='$email_id' and permission=2" ;
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if ($file_extension == 'pdf') {
        ...
        // $exists = false; 
            ...
            $sql = "INSERT INTO `admin_change_address`(`email_id`,`address`,`state`,`city`,`zip`,`police_station`,`file_upload`,`permission`) values('$email_id','$address1','$state1','$city1','$zip1','$police_station','users_images/$file_name','2')";
...
-webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );">
    ...
    WHERE police_station_list.police_email_id = admin_profile.police_station";
							...
							<div class="col-sm-9 text-secondary">
							<input type="file" name="pdf_file" id="pdf_file" class="form-control" accept=".pdf" required/>								</div>
							</div>
