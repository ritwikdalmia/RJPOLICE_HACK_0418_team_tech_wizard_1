...
if(isset($_POST['check'])){
    ...
    if(mysqli_num_rows($code_res) > 0){
        ...
        $update_otp = "UPDATE users SET token = $token WHERE token = $fetch_code";
					...
					<!--card image card -->
						...
						<div class="card-body ml-2">
							<div class="d-flex flex-column align-items-center text-left">
								...
								<img src="http://smilewellnessfoundation.org/team_tech_wizard/images/logo1.png" alt="Admin" class="rounded-circle  bg-transparent" height="200" width="300" >
