...
$showError=false;
 ...
 $sql_option3 = "
    ...
    WHERE police_station_list.police_email_id = change_address.police_station";
...
<?php include 'nav.php';?>
    ...
    $select_display2="select * from change_address where email_id='$email_id' and permission=2" ;
                        ...
                        -webkit-backdrop-filter: blur( 40px );border-radius: 10px;border: 1px solid rgba( 255, 255, 255, 0.18 );'>
                          ...
                          <tr>
                            ...
                            <td>$zip</td>
                                ...
                                <a class='btn btn-primary' href='view_uploaded_files.php?address_id=$address_id' >view uploaded file</a>
...
$select_display2="select * from change_address where email_id='$email_id' and permission=1" ;
    $sql3 = mysqli_query($conn,$select_display2);
    while($row=mysqli_fetch_assoc($sql3)){
...
$select_display2="select * from change_address where email_id='$email_id' and permission=0" ;
    $sql3 = mysqli_query($conn,$select_display2);
    while($row=mysqli_fetch_assoc($sql3)){
